...
import LeadIcon from '@/icons/HomeIcon'
import SettingsIcon from '@/icons/HomeIcon'
...
export const subscriptionPriceId = `price_1Rjm5VEDkX1DqD1cyeSGp72O`
//get this price id from the product in the sripe 
