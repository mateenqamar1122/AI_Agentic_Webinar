...
const  Pages = (props: Props) => {
  return (
    <div className="w-full mx-auto h-full">
      ...
      <div className="grid grid-cols-1 sm:gri-cols-2 gap-6 place-content-center">
        <FeatureCard 
    ...
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 rounded-xl bg-background-10">
      ...
      link="/lead">
        ...
        <div className="p-5 flex flex-col gap-4 items-start border rounded-xl border-border backdrop-blur-3xl">
          <div className="w-full flex justify-between items-center gap-3">
            <p className="text-primary fomt-semibold text-sm"> Conversions</p>
      ...
      <FeatureSectionLayout  
        heading="See the list of your current cutomers"
        link="/pipeline"
      >
