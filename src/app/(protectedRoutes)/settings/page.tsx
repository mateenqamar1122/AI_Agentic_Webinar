        ...
        <div className='w-full mx-auto py-8 px-4'>
            ...
            <div className="w-full p-6 border border-input rounded-lg bg-background shadow-sm">
                <div className='flex items-center mb-4'>
                    <div className='h-10 w-10 ronded-full bg-gradient-to-r from-purple-500 to-indigo-600 items-center justify-center mr-4'>
                        <svg
                            width="24"
                            height="24"
                            viewBox='0 0 24 24'
                    ...
                    <div>
                        ...
                        <p className='text-muted-foreground text-sm'>
                            Connects your Stripe account to start accepting payments
                        </p>
                    </div>
                </div>
                    ...
                    <div className='flex items-start'>
                        ...
                        <div>
                            <p className='font-medium'>
                                {isConnected
                                    ? 'Your Stripe account is connected' : 'your Stripe account is not connected yet'}
                            </p>
                ...
                <div className='flex flex-col sm:flex-row items-center justify-between gap-4'>
                    <div className='text-sm text-muted-foreground'>
                        {isConnected
                            ? 'You can reconnecet anytime if needed'
                    ...
                    <Link
                        href={stripeLink}
                        className={`px-5 py-2.5 rounded-md font-medium text-sm flex otems-center gap-2 transition-colors ${isConnected
                                ? 'bg-muted hover:bg-muted/80 text-foregroud'
