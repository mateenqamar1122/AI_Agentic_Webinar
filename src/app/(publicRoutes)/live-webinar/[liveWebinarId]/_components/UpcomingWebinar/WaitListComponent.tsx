...
const WaitListComponent = ({ webinarId, webinarStatus, onRegistered }: Props) => {
        ...
        try {
            ...
            if (res.data?.user) {
                setAttendee({
                    ...
                    callStatus: "PENDING",
                    createdAt: new Date(),    // gpt suggestion
                    updatedAt: new Date()       // gpt suggestion
                })
            }
    ...
    return (
        <Dialog
            ...
            >
                <DialogHeader
                    className='justify-center items-center border border-input rounded-xl p-4 bg-background'>
                        ...
                        >
                            ...
                            : 'Registering...'}
                                ...
                                webinarStatus === WebinarStatusEnum.LIVE ?  (
                                    ...
                                    "You've succcessfully joined the waitlist! "
                                )
                            ) : webinarStatus === WebinarStatusEnum.LIVE ? (
                                'Join Now'
                            ): (
