    ...
    useEffect(() => {
        ...
        const initClient = async () => {
            try {
                ...
                console.error('Error initialize client or joining call:', error)
        ...
        <div className='flex items-center justify-center h-screen bg-background text-foreground'>
            <div className='text-center max-w-md p-8 rounded-lg border border-border bg-card'>
                <h2 className='text-2xl font-bold mb-4'>
                    Please register to joinn the webinar
                </h2>
                <p className='text-mutes-foreground mb-6'>
            ...
            <div className='flex items-center justify-center h-screen bg-background text-foreground'>
                <div className='text-center max-w-md p-8 rounded-lg border border-border bg-card'>
                    ...
                    <div className='relative mx-auto w-24 h-24 mb-6'>
                        {/* <div className='abolute inset-0 rounded-full border-t-2 border-accent-primary animate-spin'></div> */}

                        <div className='absolute inset-3 rounded-full bg-card flex items-center justify-center'>
                            <Loader2 className='h-10 w-10 text-accent-primary animate-pulse animate-spin'/>
                        </div>
                    ...
                    <div className='mt-6 flex justify-center space-x-1'>
                        ...
                        <span className='h-2 w-2 bg-accent-primary rounded-full aniamte-bounce'
                    ...
                    {connectionStatus === 'reconnecting' && (
                        <>
                        <div className='mx-auto w016 h-16 mb-4 text-primary-amber-500'>
